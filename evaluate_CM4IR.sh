...
python main.py --config lsun_bedroom_256.yml --path_y lsun_bedroom --deg inpainting \
  ...
  --deltas_injection_type 1 --inpainting_mask_path random_80_mask.npy --model_ckpt lsun_bedroom/cd_bedroom256_lpips.pt # --deltas "0.1,0.1,0.8,0.8" --deltas_injection_type 1
